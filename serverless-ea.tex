...
\end{figure*}
The results obtained show that the basic Genetic Algorithm does not perform
...
Nevertheless both implementations, shown side by side, reach similar results with the same 
effort. One problem that pool-based algorithms have is the need to
