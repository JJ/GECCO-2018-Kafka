...
\end{itemize}
   ...
   The two algorithms should achieve similar results, since
...
All data generated by the different algorithm runs has also been
published, with an open data license, in the same repository,
following our usual open science policy. 
