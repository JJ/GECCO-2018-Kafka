...
number of individuals specified by the {\em Population Size} parameter, this
...
indicated by the {\em Samples per Worker} parameter. The EvoSpace parameters 
...
\begin{table}
  ...
  \begin{tabular}{|l|c|c|c|c|c|c|}
    ...
    EvoSpace Pool Size & 259 & 250 & 500 & 1000 & 2000 & 4000  \\ \hline
  \end{tabular}
\end{table}
