...
the EvoSpace \cite{GValdez2015}  pool-based architecture, using the Noiseless
BBOB testbed. It is expected that both algorithms achieve similar results as 
they are functionally equivalent. The EvoSpace algorithm presented, follows the 
